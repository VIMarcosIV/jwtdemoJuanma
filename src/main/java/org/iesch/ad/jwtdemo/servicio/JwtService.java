...
public class JwtService {
    ...
    static String secret = "Estoy harto de que me cambien librerias .... y de los putos Deprecated";
    ...
    public String creaJwt() {
        ...
        String jwtToken = Jwts.builder().claim("name", "Juanma")
                .claim("email","jmmorenod@iesch.org")
